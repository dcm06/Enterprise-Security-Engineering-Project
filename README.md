...
## PHASE 1 — User Administration and Security Policies
Goals: 
* Set up Standard Workstations
* Join them to the domain
* Create User Accounts
* OUs
* Create Group Policy Objects for Security configurations.
* Assign users and computers to OUs and Security Groups
* Enforce GPOs

What was Achieved:

Workstation Setup and Joined to the Domain:
   * L-PC1 - Office Lan Segment
   * L-PC2 - Store LAN Segment

User Account Creation
  * James Wilkins - j_wilkins - IT Department - Helpdesk
  * Sarah Scott - s_scott - IT Department - Web Admin
  * C Madubuko - cmadubuko_admin - Systems Admin
  * c_main - HR - Hiring Manager
  * c_main - store - Cashier
  * c_main - finance - accountant
  * c_main - finance - Finance manager
